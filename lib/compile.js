...
function compilePathLevel(processedPath, processed, options) {
    var tests = []
    var requireLevelCompiler = prepareTemplate(path.join( __dirname , '..', 'templates', 'require.handlebars'))
    var pathLevelCompiler = prepareTemplate(path.join( __dirname , '..', 'templates', 'pathLevelDescribe.handlebars'))
...
function compileOperationLevel(processedOp, processedPath, processed, options) {
    var tests = []
    var operationLevelCompiler = prepareTemplate(path.join( __dirname ,'..', 'templates', 'operationLevelDescribe.handlebars'))
...
function compileTransactionLevel(transaction, processedOp, processedPath, processed, options) {
    var transactionCompiler = prepareTemplate(path.join( __dirname , '..', 'templates', 'transactionLevel.handlebars'))
