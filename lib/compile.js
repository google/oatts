...
/**
 * GeneratedTest is the final result of procressing a spec & compiling the test code
...
function compilePathLevel(processedPath, processed, options) {
    var tests = []
    var requireLevelCompiler = prepareTemplate('./templates/require.handlebars')
    var pathLevelCompiler = prepareTemplate('./templates/pathLevelDescribe.handlebars')
...
function compileOperationLevel(processedOp, processedPath, processed, options) {
    var tests = []
    var operationLevelCompiler = prepareTemplate('./templates/operationLevelDescribe.handlebars')
...
function compileTransactionLevel(transaction, processedOp, processedPath, processed, options) {
    var transactionCompiler = prepareTemplate('./templates/transactionLevel.handlebars')
